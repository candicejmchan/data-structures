...
class DiaryEntry { //put the things you want to include 
  ...
  constructor(primaryKey, date, taste, meal, narrative) {
    this.pk = {};
    this.pk.S = primaryKey.toString(); //number primary key
    this.date = {}; 
    this.date.S = new Date(date).toDateString(); //string
    this.meal ={}; 
    this.meal.S = meal; 
    this.taste ={};
    this.taste.S= taste;
...
diaryEntries.push(new DiaryEntry(0, 'October 10, 2018', 'breakfast', 'bitter', 'This food reminds me of'));
diaryEntries.push(new DiaryEntry(1, 'October 11, 2018', 'lunch', 'sour', 'I wonder what cuisine this is'));
diaryEntries.push(new DiaryEntry(2, 'October 12, 2018', 'dinner', 'sweet', 'I want to make this recipie soon!'));
diaryEntries.push(new DiaryEntry(3, 'October 13, 2018', 'breafast', 'salt', 'I have never tasted anything this yummy before')); // for nosql, the numbers do not make sense
